...
public class Ui_MainWindow implements com.trolltech.qt.QUiForm<QMainWindow>
{
    ...
    public void setupUi(QMainWindow MainWindow)
    {
        ...
        menuPisos = new QMenu(menubar);
        menuPisos.setObjectName("menuPisos");
        ...
        menubar.addAction(menuPisos.menuAction());
        menubar.addAction(menuReservas.menuAction());
        menuPisos.addAction(actionPido_1);
        menuPisos.addAction(actionPiso_2);
    ...
    void retranslateUi(QMainWindow MainWindow)
    {
        ...
        menuPisos.setTitle(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Pisos", null));
